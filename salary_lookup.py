...
STRIP_PATTERNS = [
    ...
    # Indian & Global corporate suffixes
    r"\bpvt\.?\s*ltd\.?", r"\bprivate\s+limited\b", r"\bllp\b",
    r"\btechnologies\s+(?:india|pvt|ltd)\b", r"\bsolutions\s+(?:india|pvt|ltd)\b",
    r"\bservices\s+(?:india|pvt|ltd)\b", r"\bindia\s+pvt\.?\s*ltd\.?",
    r"\binc\.?\b", r"\bincorporated\b", r"\bcorp\.?\b", r"\bcorporation\b",
    r"\bllc\b", r"\bltd\.?\b", r"\blimited\b", r"\bgmbh\b", r"\bag\b",
